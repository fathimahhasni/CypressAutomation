...
//css_colour['Blue'] => 'background-colour: yellow;'
...
class Homepage{
    ...
    async submit_quote(quote, colour){
        ...
        //cy.get(locator.datatestid.cont_colour).should('have.attr', 'style').then((colour)=>{
        //    expect(colour).to.be.equal(css_colour[colour]);
        //})        
